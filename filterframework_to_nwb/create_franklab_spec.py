...
# This module will create two YAML (.yaml) files at the locations defined in
# the 'namespace_path' and 'extension_path' variables below.
...
# The paths below are also 'exported' in __init__.py and so are available to
# users as:
